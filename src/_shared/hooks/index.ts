...
export const isCreateReactApp_Context = ({ noStrictEnvCheck = false }) => {
...
export const isViteApp_Context = () => {
...
export const isJestEnv_Capable = ({ noStrictEnvCheck = true }) => {
...
export const isVitestEnv_Capable = () => {
  return (
